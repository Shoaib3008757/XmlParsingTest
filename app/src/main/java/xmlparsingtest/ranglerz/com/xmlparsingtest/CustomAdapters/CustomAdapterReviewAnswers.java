 ...
 */
public class CustomAdapterReviewAnswers extends ArrayAdapter<ReviewAnswers> {
   ...
   public  int layoutResourceId;
    ...
    public CustomAdapterReviewAnswers(Context context, int resource,UserChoiceTakeTest userChoiceTakeTest) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            questionText = Splash.randomQuestions.get(position).getQuestionText().toString().trim();
            holder.questionText.setText(questionText);

            // get the correct answer of the question

            questionAnswer = Splash.randomQuestions.get(position).getCorrectAnswer().toString().trim();

            userAnswer = userChoiceTakeTest.selectedAnswerText.get(position).toString().trim();

            // get correct image name
            correctImageName = Splash.randomQuestions.get(position).getCorrectImage().toString().trim();
