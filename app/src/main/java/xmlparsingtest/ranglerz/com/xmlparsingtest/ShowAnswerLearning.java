 ...
 */
public class ShowAnswerLearning  extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        text = LearnByChapter.randomLearningQuestions.get(position).getQuestionText().toString();
...
//                    answer4.setBackgroundDrawable(greenColorBorder);
    ...
    public void showExplanationDialog(final String explainationText){
        ...
        /*AlertDialog.Builder builder = new AlertDialog.Builder(ShowAnswerLearning.this);
        ...
        final Dialog dialog = new Dialog(ShowAnswerLearning.this);
