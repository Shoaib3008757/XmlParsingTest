 ...
 */
public class PracticeFavourite extends AppCompatActivity implements TextToSpeech.OnInitListener{



    public static final int TEST_PASS_LIMIT = 35;
    public static int RANDOM_LIST_SIZE = Menu_Activity.randomQuestions.size();
    ...
    private static final String TAG = "Random Test";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_random_test);
        Log.d("tag", "Random Quesiton size is " + Menu_Activity.randomQuestions.size());
        ...
        // these are the selection images that show the selection
        // of the button background images..
    ...
    public void displayQuestionAndAnswer()
    {
        ...
        Log.d(TAG, "Question id is " + Menu_Activity.randomQuestions.get(currentQuestion).getQuestionId());
        Log.d(TAG, "Answers List size is " + Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().size());


        // this is here we display qeustion images
        // if question text is not present then show question images...

              if(Menu_Activity.randomQuestions.get(currentQuestion).getQuestionImage() != null) {
                  if (!Menu_Activity.randomQuestions.get(currentQuestion).getQuestionImage().isEmpty()) {

                      // get input stream
                      InputStream ims = null;
                      try {
                          ims = getAssets().open("images/" + Menu_Activity.randomQuestions.get(currentQuestion).getQuestionImage().toString().trim());
                      } catch (IOException e) {
                          e.printStackTrace();
                      }
        ...
        if( Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(0).getAnswerText().isEmpty()) {
            ...
            questionText.setText(Menu_Activity.randomQuestions.get(currentQuestion).getQuestionText().toString());
            text = Menu_Activity.randomQuestions.get(currentQuestion).getQuestionText().toString();
            speackButtonClickListener(text);

            questionCategory.setText(Menu_Activity.randomQuestions.get(currentQuestion).getTopic().toString());
            correctImage = Menu_Activity.randomQuestions.get(currentQuestion).getCorrectImage();

            imageName = Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(0).getImageName().toString().trim();
            Log.d(TAG, "ImageName is" + imageName);
            imageName1 = Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(1).getImageName().toString().trim();
            Log.d(TAG,"ImageName is"+imageName1);
            imageName2 = Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(2).getImageName().toString().trim();
            Log.d(TAG, "ImageName is"+imageName2);
            imageName3 = Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(3).getImageName().toString().trim();
        ...
        correctAnswer =  Menu_Activity.randomQuestions.get(currentQuestion).getCorrectAnswer().toString().trim();
        ...
        speackButtonClickListener(text);
        questionCategory.setText(Menu_Activity.randomQuestions.get(currentQuestion).getTopic().toString());
        questionNumber.setText("Question " + questionNumberIncremented + " off "+Menu_Activity.randomQuestions.size());


        /// setting the answer of the questions...
        answer1.setText(Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(0).getAnswerText());
        textAnswer1 = Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(0).getAnswerText().toString();
        ans1ButtonSpeech(textAnswer1);



        answer2.setText(Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(1).getAnswerText());
        textAnswer2 = Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(1).getAnswerText().toString();
        ans2ButtonSpeech(textAnswer2);



        answer3.setText(Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(2).getAnswerText());
        textAnswer3 = Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(2).getAnswerText().toString();
        ans3ButtonSpeech(textAnswer3);



        answer4.setText(Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(3).getAnswerText());
        textAnswer4 = Menu_Activity.randomQuestions.get(currentQuestion).getAnswerList().get(3).getAnswerText().toString();
    ...
    public void nextButtonClick(View v) throws IOException {
        ...
        if( currentQuestion >= Menu_Activity.randomQuestions.size() )
        {
...
//
    ...
    public void ShowFlagDialog(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PracticeFavourite.this);
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent i = new Intent(PracticeFavourite.this,ShowFlaggedQuestions.class);
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                .setNegativeButton("Review Answers", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Intent i = new Intent(PracticeFavourite.this, ReviewAnswerFavourite.class);
                        i.putExtra("object", userChoiceTakeTest);
                        startActivity(i);
