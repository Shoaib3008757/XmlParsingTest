...
import xmlparsingtest.ranglerz.com.xmlparsingtest.Menu_Activity;
import xmlparsingtest.ranglerz.com.xmlparsingtest.R;
import xmlparsingtest.ranglerz.com.xmlparsingtest.ReviewAnswerFavourite;
 ...
 */
public class CustomAdapterReviewAnswerFavourite extends ArrayAdapter<ReviewAnswerFavourite> {
    ...
    public CustomAdapterReviewAnswerFavourite(Context context, int resource,UserChoiceTakeTest userChoiceTakeTest) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            questionText = Menu_Activity.randomQuestions.get(position).getQuestionText().toString().trim();
            holder.questionText.setText(questionText);

            // get the correct answer of the question

            questionAnswer = Menu_Activity.randomQuestions.get(position).getCorrectAnswer().toString().trim();
            ...
            correctImageName = Menu_Activity.randomQuestions.get(position).getCorrectImage().toString().trim();
