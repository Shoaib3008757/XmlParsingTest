 ...
 */
public class ShowAnswerLearningCaseStudy extends AppCompatActivity implements TextToSpeech.OnInitListener{


    public static final String TAG = "Show Answer";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Question from random array is " + LearnByChapter.randomLearningQuestions.get(position).getQuestionText());
        Log.d(TAG, "Correct Answer from random array is " + LearnByChapter.randomLearningQuestions.get(position).getCorrectAnswer());
        ...
        questionCategory.setText(LearnByChapter.randomLearningQuestions.get(position).getTopic());

        questionText = (TextView) findViewById(R.id.questionText);
        questionText.setText(LearnByChapter.randomLearningQuestions.get(position).getQuestionText() +"\n" +"\n"
        + LearnByChapter.randomLearningQuestions.get(position).getQuestionExplaination().toString()
        );

        text = LearnByChapter.randomLearningQuestions.get(position).getQuestionText() +"\n" +"\n"
                + LearnByChapter.randomLearningQuestions.get(position).getQuestionExplaination().toString();
        ...
        questionNumber.setText(currentQuestionNumber + " Off 50");
        ...
        explain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String explanationText = LearnByChapter.randomLearningQuestions.get(position).getQuestionExplaination();
        ...
        answer1.setTextColor(getResources().getColor(android.R.color.white));
        answer2.setTextColor(getResources().getColor(android.R.color.white));
        answer3.setTextColor(getResources().getColor(android.R.color.white));
        answer4.setTextColor(getResources().getColor(android.R.color.white));
        ...
        image1 = LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(0).getImageName();
        image2 = LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(1).getImageName();
        image3 = LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(2).getImageName();
        image4 = LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(3).getImageName();
...
//                    answer4.setBackgroundDrawable(greenColorBorder);
        ...
        Log.d(TAG,"-"+currentAnswer1+"-"+currentAnswer2+"-"+currentAnswer3+"-"+currentAnswer4+"size is"+LearnByChapter.randomLearningQuestions.get(position).getAnswerList().size());


        // set the text of the answer
        answer1.setText(LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(0).getAnswerText());
        textAnswer1 = LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(0).getAnswerText().toString();
        ans1ButtonSpeech(textAnswer1);


        answer2.setText(LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(1).getAnswerText());
        textAnswer2 = LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(1).getAnswerText().toString();
        ans2ButtonSpeech(textAnswer2);

        answer3.setText(LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(2).getAnswerText());
        textAnswer3 = LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(2).getAnswerText().toString();
        ans3ButtonSpeech(textAnswer3);

        answer4.setText(LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(3).getAnswerText());
        textAnswer4 = LearnByChapter.randomLearningQuestions.get(position).getAnswerList().get(3).getAnswerText().toString();
    ...
    public void showExplanationDialog(final String explainationText){
       /* // Use the Builder class for convenient dialog construction
        AlertDialog.Builder builder = new AlertDialog.Builder(ShowAnswerLearningCaseStudy.this);
        ...
        final Dialog dialog = new Dialog(ShowAnswerLearningCaseStudy.this);
