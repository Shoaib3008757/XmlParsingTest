...
/**
 * Created by User-10 on 28-Oct-16.
 */
public class TestLearnByChapter extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    public void displayQuestionAndAnswer()
    {
        ...
        if( !LearnByChapter.randomLearningQuestions.get(currentQuestion).getQuestionImage().isEmpty()) {

            // get input stream
            InputStream ims = null;
            try {
                ims = getAssets().open("images/"+LearnByChapter.randomLearningQuestions.get(currentQuestion).getQuestionImage().toString().trim());
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        textAnswer2 = LearnByChapter.randomLearningQuestions.get(currentQuestion).getAnswerList().get(1).getAnswerText().toString();
        ...
        textAnswer3 = LearnByChapter.randomLearningQuestions.get(currentQuestion).getAnswerList().get(2).getAnswerText().toString();
...
//                    answer4.setBackgroundDrawable(greenColorBorder);
    ...
    public void showOption(final int correctAnswer)
    {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(TestLearnByChapter.this);
    ...
    public void showExplanationDialog(final String explainationText){
        ...
        final Dialog dialog = new Dialog(TestLearnByChapter.this);
    ...
    public void ShowUserProgressDialog(){
        ...
        if(userChoiceTakeTest.numberOfCorrectAnswers.size() > TEST_PASS_LIMIT)
        {
            ...
            if (Splash.dbHelperClass.insertTestRecord("learnByChapter", "1", "1", getCurrentDate(), "1", Integer.toString(userChoiceTakeTest.numberOfCorrectAnswers.size()), Integer.toString(userChoiceTakeTest.numberOfWrongAnswers.size()))) {
        ...
        else
        {
            ...
            if (Splash.dbHelperClass.insertTestRecord("learnByChapter", "1", "0", getCurrentDate(), "1", Integer.toString(userChoiceTakeTest.numberOfCorrectAnswers.size()), Integer.toString(userChoiceTakeTest.numberOfWrongAnswers.size()))) {
                Log.d(TAG, "Data inserted Successfully");
            } else {
                Log.d(TAG, "Data not inserted");
            }
        ...
        builder.setNegativeButton("Review Answers", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent i = new Intent(TestLearnByChapter.this, ReviewAnswerLearning.class);
