...
public class ShowAnswerCategoryTest extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        progressBar.setMax(CategoryTest.randomCategoryQuestions.size());
        ...
        Log.d(TAG, "Question from random array is " + CategoryTest.randomCategoryQuestions.get(position).getQuestionText());
        Log.d(TAG, "Correct Answer from random array is " + CategoryTest.randomCategoryQuestions.get(position).getCorrectAnswer());
        ...
        questionCategory.setText(CategoryTest.randomCategoryQuestions.get(position).getTopic());

        questionText = (TextView) findViewById(R.id.questionText);
        questionText.setText(CategoryTest.randomCategoryQuestions.get(position).getQuestionText());
        text = CategoryTest.randomCategoryQuestions.get(position).getQuestionText().toString();
        speackButtonClickListener(text);



        questionNumber = (TextView) findViewById(R.id.questionNumber);
        questionNumber.setText(currentQuestionNumber + " Off "+CategoryTest.randomCategoryQuestions.size());
        ...
        image1 = CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(0).getImageName();
        image2 = CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(1).getImageName();
        image3 = CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(2).getImageName();
        image4 = CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(3).getImageName();
...
//                    answer4.setBackgroundDrawable(greenColorBorder);
        ...
        Log.d(TAG,"-"+currentAnswer1+"-"+currentAnswer2+"-"+currentAnswer3+"-"+currentAnswer4+"size is"+CategoryTest.randomCategoryQuestions.get(position).getAnswerList().size());


        // set the text of the answer
        answer1.setText(CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(0).getAnswerText());
        textAnswer1 = CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(0).getAnswerText().toString();
        ans1ButtonSpeech(textAnswer1);


        answer2.setText(CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(1).getAnswerText());
        textAnswer2 = CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(1).getAnswerText().toString();
        ans2ButtonSpeech(textAnswer2);

        answer3.setText(CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(2).getAnswerText());
        textAnswer3 = CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(2).getAnswerText().toString();
        ans3ButtonSpeech(textAnswer3);


        answer4.setText(CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(3).getAnswerText());
        textAnswer4 = CategoryTest.randomCategoryQuestions.get(position).getAnswerList().get(3).getAnswerText().toString();
    ...
    public void showExplanationDialog(final String explainationText){
       ...
       /* AlertDialog.Builder builder = new AlertDialog.Builder(ShowAnswerCategoryTest.this);
        ...
        final Dialog dialog = new Dialog(ShowAnswerCategoryTest.this);
