...
public class RandomTest extends AppCompatActivity implements TextToSpeech.OnInitListener{



    
    public static final int TEST_PASS_LIMIT = 35;
    public static int RANDOM_LIST_SIZE = Splash.randomQuestions.size();
...
}catch (Exception e)
{
    e.printStackTrace();
        ...
        Log.d("tag", "Random Quesiton size is " + Splash.randomQuestions.size());
    ...
    public void displayQuestionAndAnswer()
    {
        ...
        // set the text of the flag button to Flag
        flag.setText("Flag");
        ...
        Log.d(TAG, "Question id is " + Splash.randomQuestions.get(currentQuestion).getQuestionId());
        Log.d(TAG, "Answers List size is " + Splash.randomQuestions.get(currentQuestion).getAnswerList().size());


        // this is here we display qeustion images
        // if question text is not present then show question images...
        if(!Splash.randomQuestions.get(currentQuestion).getQuestionImage().isEmpty()) {

            // get input stream
            InputStream ims = null;
            try {
                ims = getAssets().open("images/"+Splash.randomQuestions.get(currentQuestion).getQuestionImage().toString().trim());
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        if( Splash.randomQuestions.get(currentQuestion).getAnswerList().get(0).getAnswerText().isEmpty()) {
            ...
            questionText.setText(Splash.randomQuestions.get(currentQuestion).getQuestionText().toString());
            text = Splash.randomQuestions.get(currentQuestion).getQuestionText().toString();
            speackButtonClickListener(text);

            questionCategory.setText(Splash.randomQuestions.get(currentQuestion).getTopic().toString());

            correctImage = Splash.randomQuestions.get(currentQuestion).getCorrectImage();

             imageName = Splash.randomQuestions.get(currentQuestion).getAnswerList().get(0).getImageName().toString().trim();
            Log.d(TAG, "ImageName is" + imageName);
             imageName1 = Splash.randomQuestions.get(currentQuestion).getAnswerList().get(1).getImageName().toString().trim();
            Log.d(TAG,"ImageName is"+imageName1);
             imageName2 = Splash.randomQuestions.get(currentQuestion).getAnswerList().get(2).getImageName().toString().trim();
            Log.d(TAG, "ImageName is"+imageName2);
             imageName3 = Splash.randomQuestions.get(currentQuestion).getAnswerList().get(3).getImageName().toString().trim();
        ...
        correctAnswer =  Splash.randomQuestions.get(currentQuestion).getCorrectAnswer().toString().trim();
        ...
        questionCategory.setText(Splash.randomQuestions.get(currentQuestion).getTopic().toString());
        questionNumber.setText("Question " + questionNumberIncremented + " off 50");


        /// setting the answer of the questions...
        answer1.setText(Splash.randomQuestions.get(currentQuestion).getAnswerList().get(0).getAnswerText());
        textAnswer1 = Splash.randomQuestions.get(currentQuestion).getAnswerList().get(0).getAnswerText().toString();
        ans1ButtonSpeech(textAnswer1);



        answer2.setText(Splash.randomQuestions.get(currentQuestion).getAnswerList().get(1).getAnswerText());
        textAnswer2 = Splash.randomQuestions.get(currentQuestion).getAnswerList().get(1).getAnswerText().toString();
        ans2ButtonSpeech(textAnswer2);

        answer3.setText(Splash.randomQuestions.get(currentQuestion).getAnswerList().get(2).getAnswerText());
        textAnswer3 = Splash.randomQuestions.get(currentQuestion).getAnswerList().get(2).getAnswerText().toString();
        ans3ButtonSpeech(textAnswer3);



        answer4.setText(Splash.randomQuestions.get(currentQuestion).getAnswerList().get(3).getAnswerText());
        textAnswer4 = Splash.randomQuestions.get(currentQuestion).getAnswerList().get(3).getAnswerText().toString();
    ...
    public void nextButtonClick(View v) throws IOException {
        ...
        if( currentQuestion >= Splash.randomQuestions.size() )
        {
           finishTest();
            return;
        }
...
//
    ...
    public void ShowFlagDialog(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(RandomTest.this);
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent i = new Intent(RandomTest.this,ShowFlaggedQuestions.class);
