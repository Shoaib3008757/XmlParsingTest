...
/**
 * Created by User-10 on 13-Oct-16.
 */
public class ShowAnswer extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Question from random array is " + Splash.randomQuestions.get(position).getQuestionText());
        Log.d(TAG, "Correct Answer from random array is " + Splash.randomQuestions.get(position).getCorrectAnswer());
        ...
        questionCategory.setText(Splash.randomQuestions.get(position).getTopic());




        questionText = (TextView) findViewById(R.id.questionText);
        questionText.setText(Splash.randomQuestions.get(position).getQuestionText());
        text = Splash.randomQuestions.get(position).getQuestionText().toString();
        ...
        image1 = Splash.randomQuestions.get(position).getAnswerList().get(0).getImageName();
        image2 = Splash.randomQuestions.get(position).getAnswerList().get(1).getImageName();
        image3 = Splash.randomQuestions.get(position).getAnswerList().get(2).getImageName();
        image4 = Splash.randomQuestions.get(position).getAnswerList().get(3).getImageName();
...
//                    answer4.setBackgroundDrawable(greenColorBorder);
        ...
        Log.d(TAG,"-"+currentAnswer1+"-"+currentAnswer2+"-"+currentAnswer3+"-"+currentAnswer4+"size is"+Splash.randomQuestions.get(position).getAnswerList().size());


        // set the text of the answer
        answer1.setText(Splash.randomQuestions.get(position).getAnswerList().get(0).getAnswerText());
        textAnswer1 = Splash.randomQuestions.get(position).getAnswerList().get(0).getAnswerText().toString();
        ans1ButtonSpeech(textAnswer1);

        answer2.setText(Splash.randomQuestions.get(position).getAnswerList().get(1).getAnswerText());
        textAnswer2 = Splash.randomQuestions.get(position).getAnswerList().get(1).getAnswerText().toString();
        ans2ButtonSpeech(textAnswer2);

        answer3.setText(Splash.randomQuestions.get(position).getAnswerList().get(2).getAnswerText());
        textAnswer3 = Splash.randomQuestions.get(position).getAnswerList().get(2).getAnswerText().toString();
        ans3ButtonSpeech(textAnswer3);

        answer4.setText(Splash.randomQuestions.get(position).getAnswerList().get(3).getAnswerText());
        textAnswer4 = Splash.randomQuestions.get(position).getAnswerList().get(3).getAnswerText().toString();
    ...
    public void showExplanationDialog(final String explainationText){
       ...
       /* AlertDialog.Builder builder = new AlertDialog.Builder(ShowAnswer.this);
        ...
        builder.create().show();
*/
        final Dialog dialog = new Dialog(ShowAnswer.this);
